...
SELECT * FROM FUNCIONARIO ORDER BY VAL_SALARIO DESC
SELECT * FROM FUNCIONARIO ORDER BY VAL_SALARIO
SELECT AVG(VAL_SALARIO) AS 'MEDIA SALARIO FUNCIONARIO' FROM FUNCIONARIO 
SELECT COUNT(*) AS 'QTD SALARIO' FROM FUNCIONARIO WHERE VAL_SALARIO>(SELECT AVG(VAL_SALARIO) FROM FUNCIONARIO) ---QUANTIDADE DE SALARIOS ACIMA DA MEDIA DE SALARIOS
SELECT NOM_CARGO, COUNT(NOM_CARGO) AS 'TOTAL' FROM CARGO GROUP BY NOM_CARGO
SELECT AVG(VAL_SALARIO_BASE) AS 'MEDIA' FROM CARGO WHERE NOM_CARGO='PROGRAMADOR'
